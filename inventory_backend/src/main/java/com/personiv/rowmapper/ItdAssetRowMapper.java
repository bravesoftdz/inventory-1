...
public class ItdAssetRowMapper implements RowMapper<ItdAsset>{

	
	@Override
	public ItdAsset mapRow(ResultSet rs, int row) throws SQLException {
		
		ItdAsset itdAsset = new ItdAsset();
		...
		itdAsset.setId(rs.getLong("asId"));
		itdAsset.setCreatedAt(rs.getDate("asCreated"));
		itdAsset.setUpdatedAt(rs.getDate("asUpdated"));
		
		if(locationId != null) {
			ItdRoom loc = new ItdRoom();
...
//			
//			Model hsmo = new Model();
//			hsmo.setId(rs.getLong("hsModelId"));
//			hsmo.setName(rs.getString("hsModelName"));
//			hsmo.setCreatedAt(rs.getTimestamp("hsModelCreated"));
//			hsmo.setUpdatedAt(rs.getTimestamp("hsModelUpdated"));
//			
//			hs.setModel(hsmo);
