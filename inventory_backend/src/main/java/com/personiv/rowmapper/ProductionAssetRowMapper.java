...
public class ProductionAssetRowMapper implements RowMapper<ProductionAsset>{

	
	@Override
	public ProductionAsset mapRow(ResultSet rs, int arg1) throws SQLException {
		...
		ProductionAsset assetLocation = new ProductionAsset();
		...
		if(monitorId2 != 0) {
			...
			assetLocation.setMonitor2(mon2);
		}
